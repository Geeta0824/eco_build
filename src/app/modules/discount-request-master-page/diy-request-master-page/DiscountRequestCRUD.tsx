...
// =================Discount URL=====================
export const GET_DISCOUNT_REQUEST_LIST = `${BASE_API_URL}/Quotation/GetReqListForExtraDiscForAdmin` //Get Discount List
export const GET_DISCOUNT_REQUEST_LIST_Pagination = `${BASE_API_URL}/Quotation/GetReqListForExtraDiscForAdmin_Pagination` //Get Discount List
export const GET_STATUS_LIST = `${BASE_API_URL}/Quotation/GetDiscountStatusList` //Get Discount Status List
export const RESP_EXTRA_DISCOUNT_BY_ADMIN = `${BASE_API_URL}/Quotation/RespForExtraDisctByAdmin` //Get Discount Status List
...
// =========================Get Discount=====================
export function getDiscountListApi_Pagination(
  employeeID: number,
  customerID: number,
  searchText: string,
  pageNumber: number,
  ...
  return axios.post(GET_DISCOUNT_REQUEST_LIST_Pagination, {
    employeeID,
    customerID,
    searchText,
    pageNumber,
