...
// =================Discount URL=====================
export const GET_DISCOUNT_REQUEST_LIST = `${BASE_API_URL}/TurnkeyCustomQuotation/GetReqListForExtraDiscForAdminTurnkeyQuot` //Get Discount List
export const GET_STATUS_LIST = `${BASE_API_URL}/Quotation/GetDiscountStatusList` //Get Discount Status List
export const RESP_EXTRA_DISCOUNT_BY_ADMIN = `${BASE_API_URL}/TurnkeyCustomQuotation/RespForExtraDisctByAdminTurnkeyQuot` //Get Discount Status List
