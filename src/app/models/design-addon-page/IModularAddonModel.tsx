export interface ICartLisyByModularAddonModel {
  ...
  export interface IModularAddonCheckOutModel {
    primaryID?: any
    productID: number
    productName: string
    description: string
  ...
  export interface IModularAddonReduxModel {
    quotationId: number
    count: number
  }
  
  export interface IModularAddonProductListModel {
    areaName: any
    productID: number
    productCategoryID: number
    productName: string
  ...
  export interface IModularAddonModel {
    modularAddonID: number
    quotationID: number
  ...
  export const modularAddonInitValues: IModularAddonModel = {
    modularAddonID:0,
    quotationID: 0,
    quotationNumber: '',
    projectName: '',
