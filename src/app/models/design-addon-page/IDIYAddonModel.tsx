export interface ICartLisyByDIYAddonModel {
  ...
  titleAreaID: number
  isAddonByDesigner: boolean
  isRemovedByDesigner: boolean
}
export interface IDIYAddonCheckOutModel {
  primaryID?: any
  productID: number
  productName: string
  description: string
...
export interface IDIYAddonReduxModel {
  quotationId: number
  count: number
}

export interface IDIYAddonProductListModel {
  areaName: any
  productID: number
  productCategoryID: number
  productName: string
...
export interface IDIYAddonModel {
  diyAddonID: number
  quotationID: number
...
export const diyAddonInitValues: IDIYAddonModel = {
  diyAddonID: 0,
  quotationID: 0,
  quotationNumber: '',
  projectName: '',
...
export interface IDesignDIYAddonModel {
  quotationID: number
  customerID: number
  employeeID: number
  projectID: number
