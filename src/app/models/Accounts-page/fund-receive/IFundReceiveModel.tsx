...
export interface IFundReceiveModel {
...
export const FundReceiveInitValues: IFundReceiveModel = {
  projectName: '',
  FromSubaccountID: 0,
  ToSubaccontID: 0,
  projectAmount: 0,
...
export interface IFundRecListModel {
...
export interface IProjectDropDwnModel {
  projectID: number
  projectName: string
}
