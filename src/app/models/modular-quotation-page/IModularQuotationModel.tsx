...
export interface IModularCheckOutModel {
  primaryID?: any
  productID: number
  productName: string
  description: string
...
export interface IModularReduxModel {
  quotationId: number
  count: number
}

export interface IModularProductListModel {
  areaName: any
  productID: number
  productCategoryID: number
  productName: string
...
export interface IModularQuotationModel {
  quotationID: number
...
export const modularQuotationInitValues: IModularQuotationModel = {
  quotationID: 0,
  quotationNumber: '',
  projectName: '',
  projectNumber: '',
