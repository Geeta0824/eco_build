...
const AddProjectVendorOld: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      getVenderData(ProjectName, projectCategoryID)
    }, 100)
  }, [])

  function getVenderData(ProjectName: string, projectCategoryID: number) {
    getVenderWebList()
      .then((response) => {
                      ...
                      >
                        ...
                        <div className='col-lg-3 fv-row'>
                          <div className='form-check form-switch'>
                            ...
                            />
                            <span className='text-muted fs-7'> (Check if GST Applicable)</span>
                          </div>
                        </div>
                        <label
                          className={
