...
import {
  editProjectAlbumDetails,
  getProjectAlbumByAlbumIDApi,
...
const EditProjectAlbum: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      getProjectAlbumDataByID(projectID, projName, customerName)
    }, 100)
  }, [])

  function getProjectAlbumDataByID(projectID: number, projName: string, customerName: string) {
    getProjectAlbumByAlbumIDApi(parseInt(albumId))
      .then((response) => {
        if (response.data.isSuccess == true) {
          formik.setFieldValue('projectAlbumID', response.data.projectAlbumID)
          formik.setFieldValue('albumName', response.data.albumName)
          setState({
            ...state,
            projectID: projectID,
            projName: projName,
...
export default EditProjectAlbum
