...
const SundryDebtorReportPDF: React.FC<Props> = () => {
  ...
  function getSundryDebtorPDF(mainSearch: string) {
    ...
    URL = `${process.env.REACT_APP_API_URL}/ProjectStatus/Download_SundryDebitorsList_PDF`
    ...
    axios
      ...
      .then((blob) => {
        ...
        const fileName = 'Sundry_Debtors_' + Tdate + '.pdf'
    ...
    <>
      <div className='text-end '>
        <span
          ...
          onClick={() => {
            history.push({
              pathname: '/account-reports/sundry-debtor/list',
...
export default SundryDebtorReportPDF
