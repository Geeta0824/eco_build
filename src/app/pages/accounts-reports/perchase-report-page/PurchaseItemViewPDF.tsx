...
const PurchaseItemViewPDF: React.FC<Props> = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      let PurchaseID: any = lc.PurchaseID
      ...
      getPurchaseItemPDF(PurchaseID, VendorID, StartDate, EndDate, SearchText, VendorName)
    }, 100)
  }, [])

  function getPurchaseItemPDF(
    PurchaseID: number,
    VendorID: number,
    StartDate: string,
    EndDate: string,
    ...
    URL = `${process.env.REACT_APP_API_URL}/PurchaseMasters/Download_PurchaseItemList_PDF`
    ...
    axios
      ...
      .then((blob) => {
        ...
        const fileName = 'Purchase_Item_Report_' + Tdate + '.pdf'
...
export default PurchaseItemViewPDF
