...
import {
  getModularAddonWorkDueAmountBreakupListApi,
  getModularOtherWorkDueAmountBreakupListApi,
  getPMCModularDueAmountBreakupListApi,
...
interface IDesignation {
  loading: boolean
  paymentModularDueData: IPaymentDueReportModel[]
  mdrAddonWorkOdrDueData: IAddonWorkOdrReportModel[]
  mdrOtherVenWorkOdrDueData: IOtherWorkReportModel[]
...
const ModularDueDetailsStageWiseList: React.FC<Props> = () => {
  const [modalLoader, setModalLoader] = useState(false)
  const location = useLocation()
  const [state, setState] = useState<IDesignation>({
    loading: false,
    paymentModularDueData: [] as IPaymentDueReportModel[],
    mdrAddonWorkOdrDueData: [] as IAddonWorkOdrReportModel[],
    mdrOtherVenWorkOdrDueData: [] as IOtherWorkReportModel[],
  ...
  function getModularStageWiseData(
    projectData: IVendorReportModel,
    vendorID: number,
    vendorTypeID: number,
    companyName: string,
    ...
    getPMCModularDueAmountBreakupListApi(projectData.projectID, vendorID)
      .then((response) => {
        ...
        if (response.data.isSuccess == true) {
          ...
          setState({
            ...state,
            paymentModularDueData: responseData,
          ...
          setState({...state, paymentModularDueData: []})
          setModalLoader(false)
        }
      })
      .catch((error) => {
  ...
  function getTmpModularStageWiseData() {
    getPMCModularDueAmountBreakupListApi(state.projectID, state.vendorID)
      .then((response) => {
        const responseData = response.data.responseObject
        if (response.data.isSuccess == true) {
          setState({
  ...
  // =============== Addon Work Api =================
  function getModularAddonWorkWiseData() {
    getModularAddonWorkDueAmountBreakupListApi(state.projectID, state.vendorID)
      .then((response) => {
        const responseData = response.data.responseObject
        if (response.data.isSuccess == true) {
          let totalAmt: any = 0
          ...
          setState({
            ...state,
            mdrAddonWorkOdrDueData: responseData,
  ...
  // =============== Other Work Api =================
  function getModularOtherWorkWiseData() {
    getModularOtherWorkDueAmountBreakupListApi(state.projectID, state.vendorID)
      .then((response) => {
        const responseData = response.data.responseObject
        if (response.data.isSuccess == true) {
          let totalAmt: any = 0
          ...
          setState({
            ...state,
            mdrOtherVenWorkOdrDueData: responseData,
  ...
  function handleChangeTab(type: number) {
    state.paymentModularDueData = []
    state.mdrAddonWorkOdrDueData = []
    state.mdrOtherVenWorkOdrDueData = []
    setModalLoader(false)
    if (type == 0) {
      getTmpModularStageWiseData()
    } else if (type == 1) {
      getModularAddonWorkWiseData()
    } else if (type == 2) {
      getModularOtherWorkWiseData()
    }
    setTab(type)
  }
    ...
    <>
      <div className='text-end'>
        <Link
          ...
          to={{
            pathname:
              location.pathname == '/account-reports/vendor/modular-amount-due-details'
      ...
      {tab == 0 ? (
        <div className=''>
          ...
          <div className='table-responsive'>
            {/* begin::Table */}
            <table className='table table-bordered align-middle g-2 mb-2'>
              {/* begin::Table head */}
              ...
              <tbody className="border-bottom">
                ...
                {modalLoader ? (
                  ...
                  <>
                    {state.paymentModularDueData.length > 0 &&
                      state.paymentModularDueData.map((data, index) => {
                        return (
                          <tr key={index}>
                ...
                <BlankDataImageInTable
                  length={state.paymentModularDueData.length}
            ...
            <table className='table table-bordered align-middle g-2'>
              ...
              <tbody className="border-bottom">
                ...
                {modalLoader ? (
                  ...
                  <>
                    {state.mdrAddonWorkOdrDueData.length > 0 &&
                      state.mdrAddonWorkOdrDueData.map((data, index) => {
                        return (
                          <tr key={index}>
                            <td className='text-start'>
                              <span className='text-dark text-hover-primary mb-1 fs-6'>
                ...
                {/* =================== Loading get Api Data ============== */}
                <BlankDataImageInTable
                  length={state.mdrAddonWorkOdrDueData.length}
                  loading={state.loading}
                  colSpan={9}
                />
              </tbody>
            ...
            <table className='table table-bordered align-middle g-2'>
              ...
              <tbody className="border-bottom">
                ...
                {modalLoader ? (
                  ...
                  <>
                    {state.mdrOtherVenWorkOdrDueData.length > 0 &&
                      state.mdrOtherVenWorkOdrDueData.map((data, index) => {
                        return (
                          <tr key={index}>
                            <td className='text-start'>
                              <span className='text-dark text-hover-primary mb-1 fs-6'>
...
export default ModularDueDetailsStageWiseList
