...
interface IPDFLedger {
  ...
  startDate: string
  endDate: string
  selExpenseHeadName: string
  selExpenseHeadID: number
  selExpenseTypeID: number
}

const ExpenseReportPdf: React.FC<Props> = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      let expenseHeadID: any = lc.expenseHeadID
      let startDate: any = lc.startDate
      let endDate: any = lc.endDate
      let expenseHeadName: any = lc.expenseHeadName
      getProjectPDF(expenseTypeID, startDate, endDate, expenseHeadID, expenseHeadName)
    }, 100)
  }, [])
  ...
  function getProjectPDF(
    ...
    URL = `${process.env.REACT_APP_API_URL}/ExpenseMasters/Download_ExpenseType_Group_PDF`
    ...
    axios
      ...
      .then((blob) => {
        ...
        const fileName = 'ExpenseType_' + expenseHeadName + '-' + Tdate + '.pdf'
        ...
        setState({
          ...
          startDate,
          endDate,
          selExpenseHeadID: expenseHeadID,
          selExpenseTypeID: expenseTypeID,
          selExpenseHeadName: expenseHeadName,
        })
      })
  }
        ...
        <span
          ...
          onClick={() => {
            history.push({
              ...
              state: {
                mainStartDate: state.startDate,
                mainEndDate: state.endDate,
                expenseHeadID: state.selExpenseHeadID,
                expenseHeadName: state.selExpenseHeadName,
              },
            })
          }}
        >
