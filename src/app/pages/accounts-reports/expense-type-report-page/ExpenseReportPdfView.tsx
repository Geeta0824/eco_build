...
const ExpenseReportPdfView: React.FC<Props> = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      getProjectPDF(expenseTypeID, startDate, endDate)
    }, 100)
  }, [])

  function getProjectPDF(expenseTypeID: number, startDate: string, endDate: string) {
    ...
    axios
      ...
      .then((blob) => {
        ...
        const fileName = 'ExpenseType_Details_Report_' + Tdate + '.pdf'
...
export default ExpenseReportPdfView
