...
import {GetPackageListApi} from '../../../modules/package-master-page/PackageCRUD'
...
const CustomizationPackageByQuotationID: React.FC<Props> = () => {
...
export default CustomizationPackageByQuotationID
