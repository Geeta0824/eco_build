...
const AddCustomizationQuotations: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      getMultipleDropdownListData(mainCustomerID, mainEmployeeID, mainSearch)
    }, 100)
  }, [])
        ...
        createCustomizationQuotationApi(
          ...
          .then((response) => {
            if (response.data.isSuccess == true) {
              ...
              history.push({
                pathname: `/customization-quotations/add-package/${response.data.quotationID}`,
                state: {
...
export {AddCustomizationQuotations}
