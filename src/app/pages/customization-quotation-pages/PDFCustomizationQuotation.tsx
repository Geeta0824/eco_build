...
const PDFCustomizationQuotation: React.FC<Props> = () => {
  ...
  function getQuotationPdf(mainCustomerID: number, mainEmployeeID: number, mainSearch: string) {
    var URL = ''
    if (location.pathname == `/customization-quotations/admin-pdf/${parseInt(quotationID)}`) {
      URL = `${process.env.REACT_APP_API_URL}/PDF/DownloadCustomQuotationPDFForAdmin`
    } else if (
      location.pathname == `/customization-quotations/agency-breakup-pdf/${parseInt(quotationID)}`
    ) {
      URL = `${process.env.REACT_APP_API_URL}/PDF/DownloadCustomQuotationPDFForAdminWithAgency`
    } else if (location.pathname == `/customization-quotations/pdf/${parseInt(quotationID)}`) {
...
export default PDFCustomizationQuotation
