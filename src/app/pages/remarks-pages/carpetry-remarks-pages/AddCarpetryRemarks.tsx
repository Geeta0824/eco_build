...
import {addQuotationRemarksApi} from '../../../modules/remarks-master-pages/carpetry-remarks-master-page/CarpetryRemarksCRUD'
...
const profileDetailsSchema = Yup.object().shape({
 ...
 remarks: Yup.string().required('Remarks is Required'),
  typeID: Yup.number()
    .test('is-valid-typeID', 'Project Type is required', (value) => value !== 0)
    .required('Project Type is required'),
})

interface IDepartment {
  loading: boolean
  quotationRemarksData: ICarpetryRemarksModel[]
  projectTypeData: IProjectTypeodel[]
  selTypeID: number
  mainSearch: string
}

const AddCarpetryRemarks: React.FC = () => {
  ...
  const [state, setState] = useState<IDepartment>({
    loading: false,
    quotationRemarksData: [] as ICarpetryRemarksModel[],
...
export default AddCarpetryRemarks
