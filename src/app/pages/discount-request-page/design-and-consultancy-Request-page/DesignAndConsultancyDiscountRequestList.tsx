...
import ModelDesignAndConsultancyDiscountRequest from './ModelDesignAndConsultancyDiscountRequest'
...
const DesignAndConsultancyDiscountRequestList: React.FC<Props> = () => {
  ...
  function getAllCustomerSearchDropdownData(
    selEmployeeID: number,
    employeeData: IEmployeeSearchDDModel[],notifSearch:string
  ) {
 ...
 //  console.log(e)
  ...
  return (
    <>
                      ...
                      <tr key={index}>
                        ...
                        {/* <td className='text-center'>
                          {data.isCheckOut === true ? (
                            <Link
                              to={`/dnc-quotation/design-and-consultancy/pdf/${data.quotationID}`}
      ...
      <ModelDesignAndConsultancyDiscountRequest
...
export default DesignAndConsultancyDiscountRequestList
