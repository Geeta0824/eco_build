...
import {
  ...
  getDiscountListApi,
} from '../../../modules/discount-request-master-page/customize-request-master-page/CustomizationDiscountRequestCRUD'
...
const DiscountRequestListPage: React.FC<Props> = () => {
    ...
    <>
      <div className={`card `}>
        ...
        <div className='card-header border-0 py-2 ' style={{backgroundColor: '#000000'}}>
          ...
          >
            <Link
              to='/customization-quotations/add'
                      ...
                      <tr key={index}>
                        ...
                        <td className='text-center'>
                          {data.isCheckOut === true ? (
                            <Link
                              to={{
                                pathname: `/customization-quotations/pdf/${data.quotationID}`,
                                state: {
...
export default DiscountRequestListPage
