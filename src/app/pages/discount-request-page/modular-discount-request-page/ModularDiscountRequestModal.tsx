...
import {RespForModularExtraDisctByAdminApi} from '../../../modules/discount-request-master-page/modular-discount-request-master-page/ModularDiscountRequestCRUD'
...
const ModularDiscountRequestModal: React.FC<Props> = ({
  quotationID,
  discountStatusID,
  discountTypeID,
  projectNumber,
  ...
  function handleDiscounApi() {
    ...
    RespForModularExtraDisctByAdminApi(
      user.employeeID,
      quotationID,
      tmpValueDiscount,
      discStatus,
      ...
      {state.loading == true ? (
        ...
        <Modal size='xl' show={show} onHide={clearData} backdrop='true' keyboard={false}>
          <Modal.Header closeButton>
            ...
            <Modal.Title>
              Requested Discount : {reqExtraDisc} {discountTypeID === 1 ? 'Fix Value' : '%'}
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
...
export default ModularDiscountRequestModal
