...
import {GetDiscountStatusListApi} from '../../../modules/discount-request-master-page/diy-request-master-page/DiscountRequestCRUD'
import ModularDiscountRequestModal from './ModularDiscountRequestModal'
...
import {getModularDiscountListApi} from '../../../modules/discount-request-master-page/modular-discount-request-master-page/ModularDiscountRequestCRUD'
...
const ModularDiscountRequestList: React.FC<Props> = () => {
  ...
  function getAllCustomerSearchDropdownData(
    ...
    getCustomerDropSearchDownList()
      .then((response) => {
        const responseData = response.data
        getAllModularDiscountRequestData(
          selEmployeeID,
          state.selCustomerID,
          notifSearch,
          employeeData,
  ...
  // ====================================== Modular list Api=============================
  function getAllModularDiscountRequestData(
    selEmployeeID: number,
    selCustomerID: number,
    searchText: string,
    employeeData: IEmployeeSearchDDModel[],
    ...
    getModularDiscountListApi(selEmployeeID, selCustomerID, searchText)
      .then((response) => {
  ...
  function employeeChange(e: any) {
    ...
    if (e === null) {
      ...
      return getAllModularDiscountRequestData(
        0,
        state.selCustomerID,
        state.searchText,
        state.employeeData,
                      ...
                      <tr key={index}>
                        ...
                        <td className='text-center'>
                          {data.isCheckOut === true ? (
                            <Link
                              to={`/modular/modular-quotation/pdf/${data.quotationID}`}
                        ...
                        <td className={user.roleID === 2 ? 'text-center' : 'd-none'}>
                          <Link
                            to={`/modular/modular-quotation/admin-pdf/${data.quotationID}`}
                            className='btn btn-icon btn-bg-light bg-hover-primary text-hover-inverse-primary btn-sm me-1 text-primary text-hover-light'
                            data-bs-toggle='tooltip'
                            data-bs-placement='top'
                            title='Download'
...
export default ModularDiscountRequestList
