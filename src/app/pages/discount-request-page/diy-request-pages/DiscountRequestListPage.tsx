...
import {
  ...
  getDiscountListApi,
} from '../../../modules/discount-request-master-page/diy-request-master-page/DiscountRequestCRUD'
import ModalDiscountRequest from './ModalDiscountRequest'
...
const CustomizationDiscountRequestListPage: React.FC<Props> = () => {
                      ...
                      <tr key={index}>
                        ...
                        <td className='text-dark text-hover-primary text-end fw-bolder mb-1 fs-6'>
                          {data.discountTypeID === 1
                            ? `${(
                                parseFloat(data.projectFinalAmount) - parseFloat(data.reqExtraDisc)
                              ).toFixed(2)}`
                            : '-'}
                        </td>
...
export default CustomizationDiscountRequestListPage
