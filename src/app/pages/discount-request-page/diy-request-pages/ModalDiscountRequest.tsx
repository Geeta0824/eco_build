...
import {RespForExtraDisctByAdminApi} from '../../../modules/discount-request-master-page/diy-request-master-page/DiscountRequestCRUD'
...
const ModalDiscountRequest: React.FC<Props> = ({
  quotationID,
  discountStatusID,
  discountTypeID,
  projectNumber,
...
export default ModalDiscountRequest
