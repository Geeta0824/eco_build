...
import ModelCivilWithDesignDiscountRequest from './ModelCivilWithDesignDiscountRequest'
...
const CivilWithDesignDiscountRequestList: React.FC<Props> = () => {
 ...
 //  console.log(e)
  ...
  return (
    <>
            ...
            <table className='table table-bordered align-middle g-2'>
              ...
              <thead className='bg-light-primary'>
                <tr className='fw-bolder fs-5'>
                  ...
                  <th className={user.roleID === 2 ? 'w-25px text-center':'d-none'}>Cost BreakUp</th>
                </tr>
              </thead>
              {/* end::Table head */}
              {/* begin::Table body */}
                      ...
                      <tr key={index}>
                        ...
                        <td className='text-center'>
                          {data.isCheckOut === true ? (
                            <Link
                              to={`/dnc-quotation/civil-with-design-and-consultancy/pdf/${data.quotationID}`}
                        ...
                        <td className={user.roleID === 2 ? 'text-center' : 'd-none'}>
                          <Link
                            to={`/quotations/diy-quotation/admin-pdf/${data.quotationID}`}
                            className='btn btn-icon btn-bg-light bg-hover-primary text-hover-inverse-primary btn-sm me-1 text-primary text-hover-light'
                            data-bs-toggle='tooltip'
                            data-bs-placement='top'
                            title='Download'
      ...
      <ModelCivilWithDesignDiscountRequest
...
export default CivilWithDesignDiscountRequestList
