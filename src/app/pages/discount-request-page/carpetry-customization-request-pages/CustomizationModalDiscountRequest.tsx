...
import {RespForExtraDisctByAdminApi} from '../../../modules/discount-request-master-page/capetry-customize-request-master-page/CarpetryCustomizationDiscountRequestCRUD'
...
const CustomizationModalDiscountRequest: React.FC<Props> = ({
  quotationID,
  discountStatusID,
  discountTypeID,
  projectNumber,
...
export default CustomizationModalDiscountRequest
