...
import ModelCivilAndArchitectDiscountRequest from './ModelCivilAndArchitectDiscountRequest'
...
const CivilAndArchitectDiscountRequestList: React.FC<Props> = () => {
 ...
 //  console.log(e)
  ...
  return (
    <>
                      ...
                      <tr key={index}>
                        ...
                        <td className='text-center'>
                          {data.isCheckOut === true ? (
                            <Link
                              to={`/dnc-quotation/civil-and-architect/pdf/${data.quotationID}`}
      ...
      <ModelCivilAndArchitectDiscountRequest
...
export default CivilAndArchitectDiscountRequestList
