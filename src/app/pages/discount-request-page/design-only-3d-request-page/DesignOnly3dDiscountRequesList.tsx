...
import {
  ...
  getDiscountListApi,
} from '../../../modules/discount-request-master-page/design-and-consultancy-request-master-page/DesignAndConsultancyDiscountRequestCRUD'
// import ModelCivilAndArchitectDiscountRequest from './ModularDiscountRequestModal'
...
import ModelDesignOnly3dDiscountReques from './ModelDesignOnly3dDiscountReques'
...
const DesignOnly3dDiscountRequesList: React.FC<Props> = () => {
  ...
  const [state, setState] = useState<IDNC>({
    loading: false,
    ...
    <>
      <div className={`card `}>
        ...
        <div className='card-header border-0 py-2 ' style={{backgroundColor: '#000000'}}>
          ...
          >
            <Link
              to='/quotations/diy-quotation/add'
            ...
            <table className='table table-bordered align-middle g-2'>
              ...
              <thead className='bg-light-primary'>
                <tr className='fw-bolder fs-5'>
                  ...
                  <th className='min-w-25px text-center'>Discount Status</th>
                  {/* <th className='min-w-25px text-center'>Download</th>
                  <th className='min-w-25px text-center'>View Cart</th>
                  <th className='min-w-25px text-center'>Cost BreakUp</th> */}
                </tr>
              </thead>
              {/* end::Table head */}
              {/* begin::Table body */}
                    ...
                    return (
                      <tr key={index}>
                        ...
                        <td className='text-dark text-center text-hover-primary mb-1 fs-6'>
                          <span className='text-dark fw-bolder text-hover-primary mb-1 fs-6'>
                            {data.reqExtraDisc}&nbsp;{data.discountTypeID === 1 ? '(Fix Value)' : '%' }
                          </span>
                        ...
                        {/* <td className='text-center'>
                          {data.isCheckOut === true ? (
                            <Link
                              to={`/quotations/diy-quotation/pdf/${data.quotationID}`}
                        ...
                        <td className={user.roleID === 2 ? 'text-center' : 'd-none'}>
                          <Link
                            to={`/dnc-quotation/3d-design-onliy/pdf/${data.quotationID}`}
                            className='btn btn-icon btn-bg-light bg-hover-primary text-hover-inverse-primary btn-sm me-1 text-primary text-hover-light'
                            data-bs-toggle='tooltip'
                            data-bs-placement='top'
                            title='Download'
      ...
      <ModelDesignOnly3dDiscountReques
        ...
        extraDiscount={state.objDiscountRequestData.discountStatusID === 1 ? state.objDiscountRequestData.reqExtraDisc : state.objDiscountRequestData.extraDiscount}
...
export default DesignOnly3dDiscountRequesList
