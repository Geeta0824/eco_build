...
import {AddGeneratePenaltyDetailsAPI} from '../../modules/generate-penalty-master-page/GeneratePenaltyCRUD'
...
const AddPenalty: React.FC = () => {
  ...
  const [state, setState] = useState<IPenalty>({
    loading: false,
    ...
    getAllPenaltyTypeList()
      .then((response) => {
        ...
        if (responseData.isSuccess == true) {
          setState({
            ...state,
            penaltyTypeData: responseData.responseObject,
  ...
  const selectChange = (event: any) => {
    ...
    if (elementId === 'penaltyTypeID') {
      ...
      setState({...state, selPenaltyTypeID: parseInt(value)})
          ...
          <form onSubmit={formik.handleSubmit} noValidate className='form'>
            <div className='card-body border-top p-9 ms-6'>
              <div className={'row mb-6'}>
                ...
                <div className={state.selProjectID === 0 ? 'd-none' : 'col-lg-4 fv-row'}>
                  <input
                    type='text'
                ...
                <div className={state.selProjectID > 0 ? 'col-lg-3 fv-row' : 'd-none'}>
                  <input
                    type='text'
                    className='form-control form-control-lg border-0 bg-white'
