...
import {
  ...
  getModularProductCategoryByProductCategoryIdApi,
  updateModularProductCategory,
...
const EditMoudlarProductCategory: React.FC = () => {
    ...
    getModularTypeListApi()
      .then((response) => {
        if (response.data.isSuccess == true) {
          ...
          getProductMasterDataByProductMasterId(responseData,mainSearch)
        } else {
  ...
  //===========================GetdataByID============================
  function getProductMasterDataByProductMasterId(modularTypeData: IModularProductCategoryModel[],mainSearch:string) {
    getModularProductCategoryByProductCategoryIdApi(parseInt(productCategoryId))
      .then((response) => {
        if (response.data.isSuccess == true) {
          ...
          setState({
            ...
            selmodularTypeID: response.data.modularTypeID,
            mainSearch,
            loading: false,
          })
        } else {
        ...
        <div id='kt_account_profile_details' className='collapse show'>
          <form onSubmit={formik.handleSubmit} noValidate className='form'>
            ...
            <div className='card-footer d-flex justify-content-end py-6 px-9'>
              <button type='submit' className='btn btn-primary me-2' disabled={loading || fileLoader}>
              ...
              <Link className='btn btn-danger' to={{pathname:'/module/product-category/list',state:{search:state.mainSearch}}}>
                Cancel
              </Link>
            </div>
          </form>
...
export {EditMoudlarProductCategory}
