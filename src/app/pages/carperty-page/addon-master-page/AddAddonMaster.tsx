...
import {AddAddonItemApi} from '../../../modules/carpetry-master-page/addon-master-page/AddonMasterCRUD'
...
const profileDetailsSchema = Yup.object().shape({
  addonItemName: Yup.string().required('Item Name field is required'),
  itemPrice: Yup.number().required('Item Price field is required'),
    ...
    getActiveProductCategoryApi()
      .then((response) => {
        if (response.data.isSuccess == true) {
          ...
          setState({...state, productCategoryData: responseData, loading: false, mainSearch})
        } else {
        ...
        <div id='kt_account_profile_details' className='collapse show'>
          <form onSubmit={formik.handleSubmit} noValidate className='form'>
            <div className='card-body border-top p-9 ms-6'>
              ...
              <div className='row mb-6'>
                <label className='col-lg-3 col-form-label required fw-bold fs-6'>Item Price:</label>
