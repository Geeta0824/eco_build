...
import {AddCarpentaryDiscountAPI} from '../../../modules/carpetry-master-page/carpetry-discount-master-page/CarpetryDiscountCRUD'
...
const AddCarpetryDiscount: React.FC = () => {
  ...
  const formik = useFormik<ICarpetryDiscountModel>({
    ...
    onSubmit: (values) => {
      ...
      setTimeout(() => {
        ...
        if (Edit) {
          AddCarpentaryDiscountAPI(values.discountPercentage, values.branchID)
            .then((response) => {
