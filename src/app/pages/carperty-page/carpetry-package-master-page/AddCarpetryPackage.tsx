...
import {createNewPackageApi} from '../../../modules/carpetry-master-page/carpetry-package-master-page/TurnkeyPackageCRUD'
...
const AddCarpetryPackage: React.FC = () => {
        ...
        createNewPackageApi(
          ...
          .then((response) => {
            if (response.data.isSuccess == true) {
              ...
              history.push({
                pathname: `/carpetry/carpetry-pkg-mst/add-cart/${response.data.packageID}`,
                state: {
              ...
              <div className='row mb-6'>
                ...
                <div className='col-lg-4 fv-row'>
                  ...
                  {formik.touched.packageAmount && formik.errors.packageAmount && (
                    <div className='fv-plugins-message-container text-danger'>
                      <div className='fv-help-block'>{formik.errors.packageAmount}</div>
                    </div>
                  )}
                </div>
              </div>
