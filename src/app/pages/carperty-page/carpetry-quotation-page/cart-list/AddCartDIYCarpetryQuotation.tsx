...
import { GetProductListForCartNewApi, SaveTurnkeyQuotaionDetailinCartApi } from '../../../../modules/carpetry-master-page/carpetry-quotation-master-page/CarpetryQuotationCRUD'
import { IDIYProductListModel } from '../../../../models/carpetry-page/IDIYQuotationModel'
import { getTurnkeyProductListByFilter } from '../../../../modules/carpetry-master-page/carpetry-product-master-master-page/CarpetryProductMasterCRUD'
...
const AddCartDIYCarpetryQuotation: React.FC<Props> = ({
  selQuotationId,
  // tmpplanAreaID,
 ...
 //  console.log(keyword)
  ...
  function onAddToCart(objProductList: IDIYProductListModel, tmpPlanAreaID: number) {
    ...
    setMainLoading(true)
    SaveTurnkeyQuotaionDetailinCartApi(
      selQuotationId,
      ...
      <div className='card-header border-0 py-2 ' style={{backgroundColor: '#000000'}}>
        ...
        <div className='card-toolbar'>
          ...
          >
            <Link
              to={{
                pathname: `/quotations/ready-made-quotation/view-cart/${state.selQuotationID}`,
                state: {
                  packageID: 0,
                  packageTypeID: 2,
...
export {AddCartDIYCarpetryQuotation}
