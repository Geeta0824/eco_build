...
import {addTurnkeyProductImageApi} from '../../../../modules/carpetry-master-page/carpetry-product-master-master-page/carpetry-product-photos-master/ProductPhotosCRUD'
...
const AddPhotoCarpetryProduct: React.FC = () => {
  ...
  useEffect(() => {
    setTimeout(() => {
      ...
      getProjectTypeData(productID, productName, description, mainSearch, productCategoryID, unitID)
    }, 100)
  }, [])
...
export default AddPhotoCarpetryProduct
