...
import {
  getTurnkeyProductMasterByproductID,
  updateTurnkeyProductMaster,
...
const profileDetailsSchema = Yup.object().shape({
  ...
  noOfUnit: Yup.string().required('No of unit is required'),
...
const EditCarpetryProductMaster: React.FC = () => {
  ...
  //       if (response.data.isSuccess == true) {
  //         let responseData = response.data.responseObject
  //         getProductMasterDataByProductMasterId(productCategoryData, responseData)
  //       } else {
  //         toast.error(`${response.data.message}`)
  ...
  function getProductMasterDataByProductMasterId(
    ...
    getTurnkeyProductMasterByproductID(productMasterID)
      .then((response) => {
        if (response.data.isSuccess == true) {
          ...
          formik.setFieldValue('noOfUnit', response.data.noOfUnit)
...
export {EditCarpetryProductMaster}
