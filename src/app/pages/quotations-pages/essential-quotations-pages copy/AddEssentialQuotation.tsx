...
import {
  IEssentialQuotationsModel,
  essentialQuotationsInitValues as initialValues,
} from '../../../models/quotations-page/Essential-quotation-page/IEssentialQuotationsModel'
import {createEssentialQuotationsApi} from '../../../modules/quotations-master-page/essential-quotations-master-page/EssentialQuotationsCRUD'
...
const AddEssentialQuotation: React.FC = () => {
  const history = useHistory()
  const [isActive, setIsActive] = useState(false)
  const [data, setData] = useState<IEssentialQuotationsModel>(initialValues)
  const updateData = (fieldsToUpdate: Partial<IEssentialQuotationsModel>): void => {
  ...
  const formik = useFormik<IEssentialQuotationsModel>({
    initialValues,
        ...
        createEssentialQuotationsApi(
          ...
          .then((response) => {
            if (response.data.isSuccess == true) {
              ...
              history.push('/quotations/essential-quotation/list')
              setLoading(false)
            } else {
              toast.error(`${response.data.message}`)
              setLoading(false)
