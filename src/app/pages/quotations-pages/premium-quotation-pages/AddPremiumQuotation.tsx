...
import {
  IPremiumQuotationModel,
  premiumQuotationInitValues as initialValues,
} from '../../../models/quotations-page/premium-quotation-page/IPremiumQuotationModel'
...
import {createPremiumQuotationApi} from '../../../modules/quotations-master-page/premium-quotation-master-page/PremiumQuotationCRUD'
...
const AddPremiumQuotation: React.FC = () => {
  const history = useHistory()
  const [isActive, setIsActive] = useState(false)
  const [data, setData] = useState<IPremiumQuotationModel>(initialValues)
  const updateData = (fieldsToUpdate: Partial<IPremiumQuotationModel>): void => {
  ...
  const formik = useFormik<IPremiumQuotationModel>({
    initialValues,
                    ...
                    state.customerData.map((data, index) => {
                      return (
                        <tr
                          ...
                          // className={
                          //   data.isActive === false
                          //     ? 'd-none' : 'bg-hover-light-primary text-hover-primary'}
