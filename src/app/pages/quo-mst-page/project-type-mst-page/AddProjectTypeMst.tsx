...
import {addProjectTypeMasterApi} from '../../../modules/quo-mst/QuotationMstCRUD'
import {
  IProjectTypeodel,
...
const profileDetailsSchema = Yup.object().shape({
  ...
  quotationLevelID: Yup.number()
    .required('Quotation Level Type is required')
...
const AddProjectTypeMst: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      getQuotationLevelData()
    }, 100)
  }, [])

  function getQuotationLevelData() {
