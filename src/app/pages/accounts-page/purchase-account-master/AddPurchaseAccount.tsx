...
import {AddPurchaseAccountDetails} from '../../../modules/account-page/purchase-account-master-page/PurchaseAccountCRUD'
...
const AddPurchaseAccount: React.FC = () => {
  ...
  useEffect(() => {
    setTimeout(() => {
      ...
      getUnitTypeData(mainSearch)
    }, 100)
  }, [])

  // ===========================unit type API=============================
  function getUnitTypeData(mainSearch: string) {
    getActiveUnit()
      .then((response) => {
        if (response.data.isSuccess == true) {
          let responseData = response.data.responseObject
          let tmpPurchaseData: IPurchaseAccCheckModel[] = []
          ...
          tmpPurchaseData.push(tmpCheckedData)
          getVenderActiveData(responseData, tmpPurchaseData, mainSearch)
        } else {
...
export default AddPurchaseAccount
