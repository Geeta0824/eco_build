...
const AddPayPurchase: React.FC = () => {
    ...
    GetCashAccountListAPI()
      .then((response) => {
        ...
        if (response.data.isSuccess === true) {
          ...
          setState({...state, cashAccountData: [], purchaseData: [], loading: false})
        }
      })
      .catch((error) => {
        toast.error(`${error}`)
  ...
  // -------------------------- Pagination --------------------------
  const [total, setTotal] = useState(state.purchaseData.length) //  length
        ...
        <div id='kt_account_profile_details' className='collapse show'>
          <form onSubmit={formik.handleSubmit} noValidate className='form'>
            <div className='card-body border-top p-9 ms-6'>
              ...
              <div className={state.selPurchaseID === 0 ? 'd-none' : 'row mb-6'}>
                <label className='col-lg-3 col-form-label fw-bold fs-6'>
