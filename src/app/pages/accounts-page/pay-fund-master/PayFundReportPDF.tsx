...
const PayFundReportPDF: React.FC<Props> = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      getProjectPDF(VendorID, StartDate, EndDate, SearchText)
    }, 100)
  }, [])

  function getProjectPDF(VendorID: number, StartDate: string, EndDate: string, SearchText: string) {
    var URL = process.env.REACT_APP_API_URL
    URL = `${process.env.REACT_APP_API_URL}/AccountReport/Download_PayFundListReport_PDF`
    ...
    axios
      ...
      .then((blob) => {
        ...
        const fileName = 'PayFund_Report_' + Tdate + '.pdf'
...
export default PayFundReportPDF
