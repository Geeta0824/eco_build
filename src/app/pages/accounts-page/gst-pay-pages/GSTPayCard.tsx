...
const GSTPayCard: React.FC<Props> = ({
  data,
  ...
  return (
    <>
      <tr key={data.gstPaymentID}>
        <td>
          <div className='d-flex align-items-center'>
            <div className='text-dark text-hover-primary d-block mb-1 fs-6'>
              <span className='text-dark text-hover-primary fs-5'>{data.gstPayDate}</span>
            </div>
          </div>
        </td>
        <td>
        ...
        <td>
          <span className='text-dark text-hover-primary d-block mb-1 fs-6'>{data.gstAmount}</span>
