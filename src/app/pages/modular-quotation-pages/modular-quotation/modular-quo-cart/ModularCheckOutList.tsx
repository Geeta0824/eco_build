...
import {IModularCheckOutModel} from '../../../../models/modular-quotation-page/IModularQuotationModel'
import {
...
type Props = {
  checkOutList: IModularCheckOutModel[]
  listTypeID: number
  quotationID: number
  title: string
  show: boolean
...
const ModularCheckOutList: React.FC<Props> = ({
  checkOutList,
  listTypeID,
  quotationID,
  title,
  ...
  const [checkOutListNew, setCheckOutListNew] = useState<IModularCheckOutModel[]>(
    [] as IModularCheckOutModel[]
  )
  ...
  function handleContinue() {
    setLoading(true)
    ModularCheckoutQutationApi(quotationID, 1)
      .then((response) => {
  ...
  function onAddToCart(objProductList: IModularCheckOutModel) {
    setMainLoading(true)
    SaveModularQuotaionDetailInCartApi(
      quotationID,
  ...
  function handleHeightChange(event: any) {
    if (!isNaN(event.target.value)) {
      ...
      setValueHei(value)
      const Rows: IModularCheckOutModel[] = checkOutList
      for (let key in Rows) {
              ...
              <table className='table table-bordered align-middle g-2'>
                ...
                <thead className='bg-light-primary'>
                  <tr className='fw-bolder fs-5'>
                    ...
                    <th className='min-w-75px  fw-bold text-center'>
                    ...
                    <th className='min-w-150px  fw-bold text-center'>
                      <span className=' text-primary d-block'>No Of Units</span>
                      <span className=' text-info  '>Unit Name</span>
                    </th>
                      ...
                      return (
                        <tr key={index}>
                          <td className='text-start'>
                            ...
                            <span className='text-muted text-hover-primary mb-1 fs-6 d-block'>
                          ...
                          <td className='text-center'>
                            ...
                            <span className='d-block text-muted d-block '> {data.unitName}</span>
                          </td>
                      ...
                      return (
                        <tr key={index}>
                          ...
                          <td className='text-center'>
                            ...
                            <span className='d-block text-info d-block '> {data.unitName}</span>
                          </td>
                          <td className='text-dark text-hover-primary mb-1 fs-6'>
                            {data.description}
                          </td>
