...
const AddCivilWithDesign: React.FC = () => {
  ...
  function getBHKData() {
    getActiveBHKApi()
      .then((response) => {
        ...
        getAllCustomerData(responseData)
      })
      .catch((error) => {
        toast.error(`${error}`)
  ...
  function getAllCustomerData(bhkData: IBHKMasterModel[]) {
    getCustomerList()
      .then((response) => {
  ...
  const formik = useFormik<IDIYQuotationModel>({
    ...
    onSubmit: (values) => {
      ...
      setTimeout(() => {
        ...
        //         },
        //       })
        //       // history.push(`/quotations/diy-quotation/${response.data.quotationID}`)
        //       setLoading(false)
        //     } else {
        //       toast.error(`${response.data.message}`)
        //       setLoading(false)
          ...
          <form onSubmit={formik.handleSubmit} noValidate className='form'>
            <div className='card-body border-top p-9 ms-6'>
              ...
              <div className='row mb-6'>
                ...
                <div className='row mb-6'>
                <label className='col-lg-2 col-form-label required fw-bold fs-6'>Carpet Area:</label>
                <div className='col-lg-4 fv-row'>
                  <input
                    type='text'
                    className='form-control form-control-lg form-control-solid bg-light-primary'
                    placeholder=' Carpet  Area Square Feet '
                    {...formik.getFieldProps(' amtsquarfeet')}
                  />
            ...
            <div className='card-footer d-flex justify-content-end py-6 px-9'>
              ...
              <Link className='btn btn-danger ms-3' to='/dnc-quotation/civil-with-design-and-consultancy/list'>
                Cancel
              </Link>
            </div>
          </form>
