...
const EditEmployeeDocument: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      getDocumentTypeData(parseInt(employeeID), mainSearch)
    }, 100)
  }, [])
  ...
  function getEmpDocMapDataById(
    ...
    getEmpDocMapByEmpDocMapId(empDocMapID)
      .then((response) => {
  ...
  function getMediaTypeData(
    ...
    getMediaTypeApi()
      .then((response) => {
        ...
        getEmpDocMapDataById(finalempID, temDocResData, responseData, mainSearch)
      })
      .catch((error) => {
        toast.error(`${error}`)
  ...
  function getDocumentTypeData(finalempID: number, mainSearch: string) {
    getDocumentType()
      .then((response) => {
        let responseData = response.data.responseObject
        getMediaTypeData(finalempID, responseData, mainSearch)
      })
      .catch((error) => {
        toast.error(`${error}`)
  ...
  const fileUpload = (e: any) => {
    ...
    fetch(state.pathUrl + `/EmployeeDocMap/uploadEmployeeDocument/${state.selEmpID}`, {
      method: 'POST',
      body: formData,
    })
      .then((res) => res.json())
        ...
        if (Edit) {
          updateEmpDocMap(
            ...
            .then((response) => {
              ...
              history.push({
                pathname: `/organization/employee/edit/${state.selEmpID}/document/list`,
        ...
        <div id='kt_account_profile_details' className='collapse show'>
          <form onSubmit={formik.handleSubmit} noValidate className='form'>
            ...
            <div className='card-footer d-flex justify-content-end py-6 px-9'>
              ...
              <Link
                to={{
                  pathname: `/organization/employee/edit/${state.selMediaId}/document/list`,
                  state: {search: state.mainSearch},
                }}
