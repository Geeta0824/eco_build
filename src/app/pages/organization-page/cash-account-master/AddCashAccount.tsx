...
const AddCashAccount: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      getMultiDropdownForCashAccountData(mainSearch)
    }, 100)
  }, [])

  function getMultiDropdownForCashAccountData(mainSearch: string) {
    getMultiDropdownForCashAccountApi()
      .then((response) => {
  ...
  //       getAllEmployeeData(responseData)
  //     })
  //     .catch((error) => {
  //       toast.error(`${error}`)
  ...
  // function getAllEmployeeData(bankData: IOrganizationBankModel[]) {
  //   getAllEmployeeList()
  //     .then((response) => {
          ...
          <form onSubmit={formik.handleSubmit} noValidate className='form'>
                      ...
                      state.bankData.map((data, index) => {
                        return (
                          <option
                            ...
                            selected={data.organisationBankID === state.selOrgBankID ? true : false}
                          >
                            {data.bankName}
                          </option>
                        )
            ...
            <div className='card-footer d-flex justify-content-end py-9'>
              ...
              <Link
                ...
                to={{pathname: '/organization/cashaccount/list', state: {search: state.mainSearch}}}
              >
                Cancel
              </Link>
            </div>
