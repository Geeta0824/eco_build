...
import {addUser} from '../../../modules/organization-page/user-master-page/UserCRUD'
...
const AddUser: React.FC = () => {
  ...
  function getAllEmployeeSearchDropdownData(
    ...
    Employee_Get_SearchDropdown_ForUserApi()
      .then((response) => {
        ...
        <div id='kt_account_profile_details' className='collapse show'>
          <form onSubmit={formik.handleSubmit} noValidate className='form'>
            ...
            <div className='card-footer d-flex justify-content-end py-6 px-9'>
              ...
              <Link className='btn btn-danger ms-3' to={{pathname:'/organization/user/list',state:{search:state.mainSearch}}}>
                Cancel
              </Link>
            </div>
          </form>
