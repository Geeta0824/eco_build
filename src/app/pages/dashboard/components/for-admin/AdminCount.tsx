...
import {getAdminCountApi} from '../../../../modules/dashboard-page/DashboardCRUD'
...
const AdminCount: React.FC<Props> = ({className, chartColor, chartHeight, strokeColor}) => {
      ...
      <div className='card-body p-0'>
        ...
        <div className='card-p mt-n20 position-relative'>
          ...
          <div className='row g-5'>
            ...
            <div className='col-6 col-sm-6 col-md-3'>
              <div className=' bg-light-info px-6 py-8 rounded-2'>
                <p className='display-6 text-bold text-info'>{list.cntEmployee}</p>
                <span className='text-info fw-bold fs-6 mt-2'>Employees</span>
              </div>
            </div>
            {/* end::Col */}
            {/* begin::Col */}
            <div className='col-6 col-sm-6 col-md-3'>
              <div className='bg-light-danger px-6 py-8 rounded-2'>
                <p className='display-6 text-bold text-danger'>{list.cntCustomer}</p>
                <span className='text-success fw-bold fs-6 mt-2'>Customer</span>
              </div>
            </div>
            {/* end::Col */}
            {/* begin::Col */}
            <div className='col-6 col-sm-6 col-md-3'>
              <div className='bg-light-danger px-6 py-8 rounded-2'>
                <p className='display-6 text-bold text-danger'>{list.cntUser}</p>
                <span className='text-success fw-bold fs-6 mt-2'>Users</span>
              </div>
            </div>
            {/* end::Col */}
            {/* begin::Col */}
            <div className='col-6 col-sm-6 col-md-3'>
              <div className=' bg-light-info px-6 py-8 rounded-2'>
                <p className='display-6 text-bold text-info'>{list.cntBranch}</p>
                <span className='text-info fw-bold fs-6 mt-2'>Branchs</span>
              </div>
            </div>
            {/* end::Col */}
          </div>
