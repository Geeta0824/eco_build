...
const ListsWidget4_2: React.FC<Props> = ({className, items}) => {
  return (
    <div className='card card-xl-stretch mb-xl-8'>
      {/* begin::Header */}
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bolder text-dark'>Transaction</span>
          <span className='text-muted mt-1 fw-bold fs-7'>Latest transaction</span>
        </h3>
      </div>
      {/* end::Header */}
      {/* begin::Body */}
