...
const SalesNameQuotCountTotal: React.FC<Props> = ({className, lablesNames}) => {
      ...
      <div className={`card ${className}`}>
        <div className='card-header border-0 pt-5'>
          <h3 className='card-title align-items-start flex-column'>
            <span className='card-label fw-bolder fs-3 text-primary'>Employee Projects</span>
          ...
          <div className='table-responsive'>
            ...
            <table className='table table-row-dashed table-row-gray-300 table-bordered align-middle gs-0 gy-2'>
                              ...
                              <img src={toAbsoluteUrl(`${BASE_API_URL}${data.photoPath}`)} alt='' />
                                ...
                                <div className='d-flex justify-content-start flex-column'>
                                  <span className='text-dark fw-bolder text-hover-primary fs-6'>
                                    {data.bkTotalSaleWise > 0 ? data.employeeName : ''}
                                  </span>
              ...
              <tr className='text-dark'>
                <td className='border-top border-bottom border-dark text-start fw-bolder fs-5'>
                  Total
                </td>
...
export {SalesNameQuotCountTotal}
