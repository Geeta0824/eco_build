...
import {IAreaProductModel} from '../../../models/product-page/IProductMasterModel'
import {AddAreaByProductIDApi} from '../../../modules/product-master-page/product-master-page/ProductMasterCRUD'
...
const ModelPopUpPlanArea: React.FC<Props> = ({
  show,
  handleClose,
  areaMapData,
  ProductID,
  ...
  function AreaProjectItem(tech: IAreaProductModel[]) {
    ...
    addAreaByProductMstID(strSelTechid)
  }

  // ================= Add Area Function =============
  function addAreaByProductMstID(technoIds: string) {
    AddAreaByProductIDApi(technoIds, ProductID)
      .then((response) => {
  ...
  return (
    <Modal size='xl' show={show} onHide={handleClose} keyboard={false}>
      <Modal.Header closeButton style={{backgroundColor: '#2a3952'}}>
        <Modal.Title className='text-white'>Plan Area List</Modal.Title>
