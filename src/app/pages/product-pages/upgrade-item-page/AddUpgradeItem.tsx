...
import {CreateUpgradeItem} from '../../../modules/product-master-page/upgrade-item-master-page/UpradeItemCRUD'
        ...
        CreateUpgradeItem(
          ...
          .then((response: {data: {isSuccess: boolean; message: any}}) => {
            if (response.data.isSuccess == true) {
              ...
              history.push({pathname:'/p-product/upgrade-item/list',state:{search:state.mainSearch}})
              setLoading(false)
            } else {
              toast.error(`${response.data.message}`)
              setLoading(false)
    ...
    <>
      ...
      <div className='text-end'>
        <span
          ...
          onClick={() => history.push({pathname:'/p-product/upgrade-item/list',state:{search:state.mainSearch}})}
        >
          Back To List
        </span>
      </div>
