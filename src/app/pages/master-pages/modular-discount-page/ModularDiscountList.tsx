...
import {getAllModularDiscount} from '../../../modules/master-page/modular-discount-master-page/ModularDiscountCRUD'
import {ModularDiscountCard} from './ModularDiscountCard'
...
const ModularDiscountList: React.FC<Props> = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      getAllModularDiscountData(mainSearch)
    }, 100)
  }, [])

  function getAllModularDiscountData(mainSearch: string) {
    getAllModularDiscount()
      .then((response) => {
    ...
    <>
      <div className={`card `}>
        ...
        <Header_Search_Add
          searchText={name}
          filter={(e) => filter(e)}
          pathName={'/master/modular-discount/add'}
          title='Click to add a Modular Discount'
        />
        {/* <div className='card-header border-0 py-2 ' style={{backgroundColor: '#000000'}}>
          ...
          >
            <Link to='/master/modular-discount/add' className='btn btn-sm btn-light-primary bg-white'>
              ...
              <tbody className="border-bottom">
                ...
                {currentPosts.length > 0 &&
                  currentPosts.map((data, index) => {
                    return (
                      <ModularDiscountCard data={data} name={name} />
                      // <tr key={index}>
                      //   <td>
                      ...
                      //       <Link
                      //         to={`/master/modular-discount/edit/${data.discountID}`}
...
export default ModularDiscountList
