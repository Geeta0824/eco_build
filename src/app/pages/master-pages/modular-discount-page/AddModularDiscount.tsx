...
import {updateDiscount} from '../../../modules/carpetry-master-page/carpetry-discount-master-page/CarpetryDiscountCRUD'
...
import {AddDiscountAPI} from '../../../modules/master-page/discount-master-page/DiscountCRUD'
import { AddModularDiscountAPI, getModularDiscountByDiscountId } from '../../../modules/master-page/modular-discount-master-page/ModularDiscountCRUD'
...
const AddModularDiscount: React.FC = () => {
    ...
    getBranchDropdownList()
      .then((response) => {
        ...
        if (resp.isSuccess === true) {
          ...
          setState({...state, branchData: responseData, loading: false,mainSearch})
        } else {
  ...
  const formik = useFormik<ICarpetryDiscountModel>({
    ...
    onSubmit: (values) => {
      ...
      setTimeout(() => {
        ...
        if (Edit) {
            AddModularDiscountAPI(values.discountPercentage, values.branchID)
            .then((response) => {
