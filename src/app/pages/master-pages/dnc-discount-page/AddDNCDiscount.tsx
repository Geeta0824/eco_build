...
import {AddDiyDiscountAPI} from '../../../modules/master-page/dnc-discount-master-page/DNCDiscountCRUD'
import {
  IDNCDescountModel,
...
const AddDNCDiscount: React.FC = () => {
  ...
  const formik = useFormik<IDNCDescountModel>({
    ...
    onSubmit: (values) => {
      setLoading(true)
      setTimeout(() => {
        AddDiyDiscountAPI(values.discountPercentage, values.branchID)
          .then((response) => {
