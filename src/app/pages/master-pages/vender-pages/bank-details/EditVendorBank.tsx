...
import {
  IVendorBankDetailsModel,
  vendorBankDetailsIniValue as initialValues,
} from '../../../../models/master-page/IVendorBankDetailsModel'
import {
  getVenBankDetailsByVenBankIDApi,
...
const EditVendorBank: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      getVenBankDataByBankVenId(mainSearch)
    }, 100)
  }, [])

  function getVenBankDataByBankVenId(mainSearch: string) {
    getVenBankDetailsByVenBankIDApi(parseInt(bankID))
      .then((response) => {
