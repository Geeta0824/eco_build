...
import { AddDesignStageAPI } from '../../../modules/master-page/design-stage-page/DesignStageCRUD'
      ...
      <div className='text-end'>
        <span>
          <Link
            ...
            to={{pathname: '/master/design-stage/list', state: {search: mainSearch}}}
          >
            Back To List
          </Link>
        </span>
