...
import {createAllModularProjPayStructureAPI} from '../../../modules/master-page/modular-payment-structure/ModularPaymentStructureCRUD'
...
const AddModularPaymentStructure: React.FC = () => {
  ...
  const formik = useFormik<IModularPaymentSystemModel>({
    ...
    onSubmit: (values) => {
      setLoading(true)
      setTimeout(() => {
        createAllModularProjPayStructureAPI(
          values.sequenceNo,
          values.noOfDays,
          values.stageName,
          ...
          .then((response) => {
            if (response.data.isSuccess == true) {
              ...
              history.push({
                pathname: '/master/modular-pay-struc/list',
      ...
      <div className='text-end'>
        <span>
          <Link
            ...
            to={{pathname: '/master/modular-pay-struc/list', state: {search: mainSearch}}}
          >
            Back To List
          </Link>
        </span>
...
export default AddModularPaymentStructure
