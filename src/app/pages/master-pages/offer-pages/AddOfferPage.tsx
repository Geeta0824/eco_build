...
import {addOfferApi} from '../../../modules/master-page/offer-master-page/OfferCRUD'
        ...
        addOfferApi(
          ...
          .then((response) => {
            if (response.data.isSuccess === true) {
              ...
              history.push({pathname: '/master/offer/list', state: {search: mainSearch}})
            } else {
      ...
      <div className='text-end'>
        <span>
          <Link
            ...
            to={{pathname: '/master/offer/list', state: {search: mainSearch}}}
          >
            Back To List
          </Link>
        </span>
