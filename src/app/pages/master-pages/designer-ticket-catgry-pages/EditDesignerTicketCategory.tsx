...
import { getDesignerTicketByDesignerTicketId, updateDesignerTicketCategory } from '../../../modules/master-page/designer-ticket-catgry-page/DesignerTicketCategoryCRUD'
...
const EditDesignerTicketCategory: React.FC = () => {
  const {designerTicketId} = useParams<{designerTicketId: string}>()
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      getDesignerTicketCatgryDataByID(mainSearch)
    }, 100)
  }, [])

  function getDesignerTicketCatgryDataByID(mainSearch: string) {
    getDesignerTicketByDesignerTicketId(parseInt(designerTicketId))
      .then((response) => {
  ...
  const formik = useFormik<IDesignerTicketCategoryModel>({
    ...
    onSubmit: (values) => {
      setLoading(true)
      setTimeout(() => {
        updateDesignerTicketCategory(
          parseInt(designerTicketId),
          values.title,
          values.sequenceNo,
          user.employeeID,
          '192.168.0.1'
      ...
      <div className='text-end'>
        <span>
          <Link
            ...
            to={{pathname: '/master/designer-ticket-catgry/list', state: {search: state.mainSearch}}}
          >
            Back To List
          </Link>
        </span>
...
export default EditDesignerTicketCategory
