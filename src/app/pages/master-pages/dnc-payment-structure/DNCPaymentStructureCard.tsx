...
import {IDNCPaymentStructureModel} from '../../../models/master-page/IDNCPaymentStructureModel'

type props = {
  data: IDNCPaymentStructureModel
  handleShow: (id: number) => void
  dncPmtStructureBranchMapData: (dncBranchMapData: IDNCPaymentStructureModel) => void
  name: string
}
const DNCPaymentStructureCard: React.FC<props> = ({
  data,
  handleShow,
  dncPmtStructureBranchMapData,
  name,
}) => {
  useEffect(() => {
    ...
    <>
      <tr key={data.dncProjPaymentStageID}>
        ...
        <td>
          ...
          <div>
            <div
              onClick={() => dncPmtStructureBranchMapData(data)}
        ...
        <td>
          <div className='d-flex justify-content-end flex-shrink-0'>
            <Link
              to={{
                pathname: `/master/dnc-pay-struc/edit/${data.dncProjPaymentStageID}`,
...
export {DNCPaymentStructureCard}
