...
const AddComplainExpire: React.FC = () => {
  ...
  const formik = useFormik<IComplainExpireModel>({
    ...
    onSubmit: (values) => {
      ...
      setTimeout(() => {
        ...
        var objComplainExpire = btoa(JSON.stringify(createdValues))
        AddComplainExpireDetailsAPI(`${objComplainExpire}`
        )
          .then((response) => {
