...
const EducationCategoryCard: React.FC<Props> = ({data, handleShowActive, handleShow, name}) => {
      ...
      <tr key={data.eduCategoryID}>
        ...
        <td>
          <div className='d-flex justify-content-end flex-shrink-0'>
            <Link
              to={{
                pathname: `/master/eduCategory/edit/${data.eduCategoryID}`,
            ...
            <div
              onClick={() => handleShow(data.eduCategoryID)}
