...
const AddGenerateTicket: React.FC = () => {
    ...
    getAllProjectListByRoleIDAndEmployeeIDAPI(user.roleID, user.employeeID)
      .then((response) => {
        ...
        if (responseData.isSuccess == true) {
          getDesignerTicketCategoryData(temDesignEmpData, projectData)
        } else {
          toast.error(`${response.data.massege}`)
                  ...
                  >
                    ...
                    {state.designerTicketCategoryData.length > 0 &&
                      state.designerTicketCategoryData.map((data, index) => {
                        return (
                          <option key={index} value={data.designerTicketCategoryID}>
                            {data.title}
                          </option>
                        )
                      })}
                  ...
                  >
                    ...
                    {state.roleDesignerEmployeeData.length > 0 &&
                      state.roleDesignerEmployeeData.map((data, index) => {
                        return (
                          <option key={index} value={data.designerID}>
                            {data.designarName}
                          </option>
                        )
                      })}
