...
const MenuInnerWithSub: React.FC<Props> = ({
  ...
  return (
    <div ref={menuItemRef} className={`menu-item menu-lg-down-accordion ${dislpay} me-lg-1 ms-lg-5`}>
      <span
      ...
      <div
        className={clsx(
          'menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown scroll-y mh-375px',
